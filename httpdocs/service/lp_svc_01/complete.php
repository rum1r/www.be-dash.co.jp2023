...
<div id="all" class="taCtr">
	<section>
	<div id="content-8">
		<div class="title-h1">
			<h1 id="comp">【送信完了】　お問い合わせフォーム</h1>
		</div>
		<div class="content-inner">
			<div>
				<p class="compMsg topMargin60">お問い合わせが完了致しました。</p>
<p class="compMsg topMargin20">確認のため、入力いただいたメールアドレス宛てに、<br />お問い合わせ内容の確認メールを送信しております。<br />万が一メールが届かない場合は再度お問い合わせください。</p>
			</div>
		</div>
		<div id="area-btn" style="padding-bottom:10em;">
			<p class="topMargin60"><a href="index.php"><img src="images/btn-close_off.gif" alt="このページを閉じる" class="imgover" /></a></p>
		</div>
	</div>
	</section>
</div><!--#all closed-->
